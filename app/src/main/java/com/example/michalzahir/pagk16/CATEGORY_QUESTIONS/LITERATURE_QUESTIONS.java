 ...
 */
public class LITERATURE_QUESTIONS extends QUESTIONS {
    ...
    public LITERATURE_QUESTIONS(String objectId, int ID, Date created, Date updated, String ANSWER_A, String QUESTION,
