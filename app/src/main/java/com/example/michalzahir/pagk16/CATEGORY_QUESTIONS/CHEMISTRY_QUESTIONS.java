 ...
 */
public class CHEMISTRY_QUESTIONS extends QUESTIONS {
    ...
    public CHEMISTRY_QUESTIONS(String objectId, int ID, Date created, Date updated, String ANSWER_A, String QUESTION,
