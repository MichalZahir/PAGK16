 ...
 */
public class HISTORY_QUESTIONS extends QUESTIONS {
    ...
    public HISTORY_QUESTIONS(String objectId, int ID, Date created, Date updated, String ANSWER_A, String QUESTION,
