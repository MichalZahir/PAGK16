 ...
 */
public class ASTRONOMY_QUESTIONS extends QUESTIONS {
    ...
    public ASTRONOMY_QUESTIONS(String objectId, int ID, Date created, Date updated, String ANSWER_A, String QUESTION,
