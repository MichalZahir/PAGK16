 ...
 */
public class SPORT_QUESTIONS extends QUESTIONS{
    ...
    public SPORT_QUESTIONS(String objectId, int ID, Date created, Date updated, String ANSWER_A, String QUESTION,
